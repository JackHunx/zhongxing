...
--
-- ‰∏ªÊú∫: 127.0.0.1
-- ÁîüÊàêÊó•Êúü: 2013 Âπ¥ 06 Êúà 19 Êó• 10:22
...
CREATE TABLE IF NOT EXISTS `zx_account_bank` (
  ...
  `account` varchar(100) DEFAULT NULL COMMENT '’À∫≈',
  `bank` varchar(50) DEFAULT NULL COMMENT 'À˘ Ù“¯––',
  `branch` varchar(100) DEFAULT NULL COMMENT '÷ß––',
  ...
  PRIMARY KEY (`id`),
  KEY `user_id` (`user_id`)
) ENGINE=MyISAM DEFAULT CHARSET=gbk COMMENT='“¯––’ ªß' AUTO_INCREMENT=1 ;
...
CREATE TABLE IF NOT EXISTS `zx_account_cash` (
  ...
  `account` varchar(50) DEFAULT '0' COMMENT '’À∫≈',
  `bank` text COMMENT 'À˘ Ù“¯––',
  `branch` varchar(100) DEFAULT NULL COMMENT '÷ß––',
  `total` float(20,2) DEFAULT '0.00' COMMENT '◊‹∂Ó',
  `credited` varchar(20) DEFAULT '0' COMMENT 'µΩ’À◊‹∂Ó',
...
) ENGINE=MyISAM DEFAULT CHARSET=gbk COMMENT='Ã·œ÷º«¬º' AUTO_INCREMENT=1 ;
...
CREATE TABLE IF NOT EXISTS `zx_account_log` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
  `user_id` int(11) DEFAULT '0' COMMENT '”√ªßID',
  `type` varchar(100) DEFAULT NULL COMMENT '¿‡–Õ',
  ...
  PRIMARY KEY (`id`),
  KEY `user_id` (`user_id`)
) ENGINE=MyISAM  DEFAULT CHARSET=gbk COMMENT='◊ Ωº«¬º' AUTO_INCREMENT=329 ;
...
CREATE TABLE IF NOT EXISTS `zx_account_recharge` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
  `trade_no` varchar(20) DEFAULT NULL COMMENT '∂©µ•∫≈',
  `user_id` int(11) DEFAULT '0' COMMENT '”√ªßID',
  `status` int(2) DEFAULT '0' COMMENT '◊¥Ã¨',
  `money` decimal(10,2) DEFAULT '0.00' COMMENT 'Ω∂Ó',
  `payment` varchar(100) DEFAULT NULL COMMENT 'À˘ Ù“¯––',
  `return` text,
  `type` varchar(10) DEFAULT '0' COMMENT '¿‡–Õ',
  `remark` varchar(250) DEFAULT '0' COMMENT '±∏◊¢',
  `fee` varchar(10) DEFAULT NULL,
  `verify_userid` int(11) DEFAULT '0' COMMENT '…Û∫À»À',
  `verify_time` varchar(11) DEFAULT NULL COMMENT '…Û∫À ±º‰',
  `verify_remark` varchar(250) DEFAULT '' COMMENT '…Û∫À±∏◊¢',
  `addtime` varchar(11) DEFAULT NULL,
  `addip` varchar(15) DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `user_id` (`user_id`),
...
) ENGINE=MyISAM  DEFAULT CHARSET=gbk COMMENT='≥‰÷µº«¬º' AUTO_INCREMENT=35 ;
...
CREATE TABLE IF NOT EXISTS `zx_area` (
  ...
  KEY `nid` (`nid`),
  KEY `nidp` (`nid`,`pid`)
) ENGINE=MyISAM  DEFAULT CHARSET=gbk AUTO_INCREMENT=3577 ;
...
CREATE TABLE IF NOT EXISTS `zx_attestation` (
  ...
  `litpic` varchar(255) DEFAULT NULL COMMENT '»œ÷§µƒÕº∆¨',
  `content` varchar(255) DEFAULT NULL COMMENT '»œ÷§µƒºÚΩÈ',
  `jifen` int(20) DEFAULT '0' COMMENT '»œ÷§µƒª˝∑÷',
  `pic` text,
  `pic2` varchar(100) DEFAULT NULL,
  `pic3` varchar(100) DEFAULT NULL,
  `verify_time` varchar(32) DEFAULT NULL COMMENT '…Û∫À ±º‰',
  `verify_user` int(11) DEFAULT NULL COMMENT '…Û∫À»À',
  `verify_remark` varchar(250) DEFAULT NULL COMMENT '…Û∫À±∏◊¢',
  `addtime` varchar(50) DEFAULT NULL,
  `addip` varchar(50) DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `type_id` (`type_id`)
) ENGINE=MyISAM  DEFAULT CHARSET=gbk AUTO_INCREMENT=329 ;
...
CREATE TABLE IF NOT EXISTS `zx_attestation_type` (
  ...
  `name` varchar(50) DEFAULT NULL COMMENT '¿‡–Õ√˚≥∆',
  `order` varchar(10) DEFAULT NULL,
  `status` int(2) DEFAULT NULL,
  `jifen` int(20) DEFAULT '0' COMMENT 'ª˝∑÷',
  `summary` varchar(200) DEFAULT NULL COMMENT 'ºÚΩÈ',
...
CREATE TABLE IF NOT EXISTS `zx_bbs_credits` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=gbk ROW_FORMAT=FIXED AUTO_INCREMENT=9 ;
...
CREATE TABLE IF NOT EXISTS `zx_bbs_forums` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=gbk ROW_FORMAT=FIXED AUTO_INCREMENT=13 ;
...
CREATE TABLE IF NOT EXISTS `zx_bbs_posts` (
  ...
  PRIMARY KEY (`id`),
  KEY `fid` (`fid`)
) ENGINE=MyISAM  DEFAULT CHARSET=gbk ROW_FORMAT=DYNAMIC AUTO_INCREMENT=128 ;
...
CREATE TABLE IF NOT EXISTS `zx_bbs_topics` (
  ...
  PRIMARY KEY (`id`),
  KEY `topictype` (`type`)
) ENGINE=MyISAM  DEFAULT CHARSET=gbk ROW_FORMAT=DYNAMIC AUTO_INCREMENT=80 ;
...
CREATE TABLE IF NOT EXISTS `zx_borrow` (
  ...
  `user_id` int(11) DEFAULT '0' COMMENT '”√ªß√˚≥∆',
  `name` varchar(255) DEFAULT NULL COMMENT '±ÍÃ‚',
  `status` int(2) DEFAULT '0' COMMENT '◊¥Ã¨',
  `order` int(11) DEFAULT '0' COMMENT '≈≈–Ú',
  `hits` int(11) DEFAULT '0' COMMENT 'µ„ª˜¥Œ ˝',
  `litpic` varchar(255) DEFAULT NULL COMMENT 'Àı¬‘Õº',
  `flag` varchar(50) DEFAULT NULL COMMENT ' Ù–‘',
  ...
  `publish` varchar(50) DEFAULT NULL COMMENT '∑¢≤º ±º‰',
  `customer` varchar(11) DEFAULT NULL COMMENT 'øÕ∑˛',
  `number_id` varchar(50) DEFAULT NULL,
  `verify_user` varchar(11) DEFAULT NULL COMMENT '…Û∫À»À',
  `verify_time` varchar(50) DEFAULT NULL COMMENT 'øÕ∑˛',
  ...
  `monthly_repayment` varchar(50) DEFAULT NULL COMMENT '√ø‘¬ªπøÓ∂Ó',
  ...
  `use` varchar(50) DEFAULT NULL COMMENT '”√Õæ',
  `time_limit` varchar(50) DEFAULT NULL COMMENT 'ΩËøÓ∆⁄œﬁ',
  `style` varchar(50) DEFAULT NULL COMMENT 'ªπøÓ∑Ω Ω',
  `account` varchar(50) DEFAULT NULL COMMENT 'ΩË¥˚◊‹Ω∂Ó',
  `account_yes` varchar(10) DEFAULT '0',
  `tender_times` varchar(11) DEFAULT '0',
  `apr` decimal(18,2) DEFAULT NULL COMMENT 'ƒÍ¿˚¬ ',
  `lowest_account` varchar(50) DEFAULT NULL COMMENT '◊ÓµÕÕ∂±ÍΩ∂Ó',
  `most_account` varchar(50) DEFAULT NULL COMMENT '◊Ó∂‡Õ∂±Í◊‹∂Ó',
  `valid_time` varchar(50) DEFAULT NULL COMMENT '”––ß ±º‰',
  `award` varchar(50) DEFAULT NULL COMMENT 'Õ∂±ÍΩ±¿¯',
  `part_account` varchar(50) DEFAULT NULL COMMENT '∑÷ÃØΩ±¿¯Ω∂Ó',
  `funds` varchar(50) DEFAULT NULL COMMENT '±»¿˝Ω±¿¯µƒ±»¿˝',
  `is_false` varchar(50) DEFAULT NULL COMMENT '±Íµƒ ß∞‹ ±“≤Õ¨—˘Ω±¿¯ ',
  `open_account` varchar(50) DEFAULT NULL COMMENT 'π´ø™Œ“µƒ’ ªß◊ Ω«Èøˆ',
  `open_borrow` varchar(50) DEFAULT NULL COMMENT 'π´ø™Œ“µƒΩËøÓ◊ Ω«Èøˆ',
  `open_tender` varchar(50) DEFAULT NULL COMMENT 'π´ø™Œ“µƒÕ∂±Í◊ Ω«Èøˆ',
  `open_credit` varchar(50) DEFAULT NULL COMMENT 'π´ø™Œ“µƒ–≈”√∂Ó∂»«Èøˆ',
  `content` text COMMENT 'œÍœ∏Àµ√˜',
  `addtime` varchar(50) DEFAULT NULL,
  `addip` varchar(50) DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `user_id` (`user_id`),
...
CREATE TABLE IF NOT EXISTS `zx_borrow_collection` (
  ...
  `repay_time` varchar(50) DEFAULT NULL COMMENT 'π¿º∆ªπøÓ ±º‰',
  `repay_yestime` varchar(50) DEFAULT NULL COMMENT '“—æ≠ªπøÓ ±º‰',
  `repay_account` varchar(50) DEFAULT '0' COMMENT '‘§ªπΩ∂Ó',
  `repay_yesaccount` varchar(50) DEFAULT '0' COMMENT ' µªπΩ∂Ó',
...
CREATE TABLE IF NOT EXISTS `zx_borrow_line` (
  ...
  `account` varchar(11) DEFAULT NULL COMMENT '¥˚øÓΩ∂Ó',
  `content` text COMMENT 'œÍœ∏Àµ√˜',
  `pawn` varchar(2) DEFAULT NULL COMMENT '”–Œﬁµ÷—∫',
  `tel` varchar(15) DEFAULT NULL COMMENT 'µÁª∞',
  `sex` varchar(2) DEFAULT NULL COMMENT '–‘±',
  `xing` varchar(11) DEFAULT NULL COMMENT '–’',
  `verify_user` int(11) DEFAULT NULL COMMENT '…Û∫À»À',
  `verify_time` varchar(50) DEFAULT NULL COMMENT '…Û∫À ±º‰',
  `verify_remark` varchar(255) DEFAULT NULL,
  `addtime` varchar(50) DEFAULT NULL,
  `addip` varchar(50) DEFAULT NULL,
  PRIMARY KEY (`id`)
...
CREATE TABLE IF NOT EXISTS `zx_borrow_repayment` (
  ...
  `repayment_time` varchar(50) DEFAULT NULL COMMENT 'π¿º∆ªπøÓ ±º‰',
  `repayment_yestime` varchar(50) DEFAULT NULL COMMENT '“—æ≠ªπøÓ ±º‰',
  `repayment_account` varchar(50) DEFAULT '0' COMMENT '‘§ªπΩ∂Ó',
  `repayment_yesaccount` varchar(50) DEFAULT '0' COMMENT ' µªπΩ∂Ó',
  `late_days` int(11) NOT NULL DEFAULT '0',
  `late_interest` varchar(11) NOT NULL DEFAULT '0',
  `interest` varchar(50) DEFAULT '0',
  `capital` varchar(50) DEFAULT '0',
  `forfeit` varchar(50) DEFAULT '0' COMMENT '÷Õƒ…Ω',
  `reminder_fee` varchar(50) DEFAULT '0' COMMENT '¥ﬁ ’∑—',
  `addtime` varchar(50) DEFAULT NULL,
  `addip` varchar(50) DEFAULT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE IF NOT EXISTS `zx_borrow_tender` (
  ...
  `repayment_account` varchar(50) DEFAULT '0' COMMENT '◊‹∂Ó',
  `interest` varchar(11) NOT NULL DEFAULT '0',
  `repayment_yesaccount` varchar(50) DEFAULT '0' COMMENT '“—ªπ◊‹∂Ó',
  `wait_account` varchar(11) DEFAULT '0' COMMENT '¥˝ªπ◊‹∂Ó',
  `wait_interest` varchar(11) DEFAULT '0' COMMENT '¥˝ªπ¿˚œ¢',
  `repayment_yesinterest` varchar(50) DEFAULT '0' COMMENT '“—ªπ¿˚œ¢',
  `addtime` varchar(50) DEFAULT NULL,
  `addip` varchar(50) DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `user_id` (`user_id`),
...
) ENGINE=MyISAM  DEFAULT CHARSET=gbk COMMENT='’–±Í' AUTO_INCREMENT=21 ;
...
CREATE TABLE IF NOT EXISTS `zx_borrow_union` (
  ...
  `hits` int(11) DEFAULT '0' COMMENT 'µ„ª˜¥Œ ˝',
  `litpic` varchar(255) DEFAULT NULL COMMENT 'Àı¬‘Õº',
  `range` varchar(255) DEFAULT NULL COMMENT 'æ≠”™∑∂Œß',
  `content` text COMMENT 'π´ÀæºÚΩÈ',
  `verify_remark` varchar(255) DEFAULT NULL,
  `verify_time` varchar(10) DEFAULT NULL,
  `addtime` varchar(50) DEFAULT NULL,
  `addip` varchar(50) DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `zx_comment` (
  ...
  `article_id` int(11) DEFAULT NULL,
  `comment` text,
  `flag` varchar(30) DEFAULT NULL COMMENT '∂®“Â Ù–‘',
  `order` varchar(10) DEFAULT NULL COMMENT '≈≈–Ú',
  `status` int(2) DEFAULT NULL COMMENT '◊¥Ã¨',
  `addtime` varchar(30) DEFAULT NULL COMMENT 'ÃÌº” ±º‰',
  `addip` varchar(30) DEFAULT NULL COMMENT 'ÃÌº”ip',
  PRIMARY KEY (`id`)
...
CREATE TABLE IF NOT EXISTS `zx_company` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(30) NOT NULL COMMENT 'π´Àæ√˚≥∆',
  `site_id` int(11) NOT NULL COMMENT '¿∏ƒøID',
  `flag` varchar(30) NOT NULL COMMENT '∂®“Â Ù–‘',
  `status` int(2) DEFAULT NULL COMMENT '◊¥Ã¨',
  `order` varchar(10) NOT NULL COMMENT '≈≈–Ú',
  `litpic` varchar(255) NOT NULL DEFAULT '',
  `type` varchar(50) DEFAULT NULL COMMENT '…ÃŒÒ¿‡–Õ',
  `percentage` varchar(50) NOT NULL COMMENT '≥ˆø⁄∞Ÿ∑÷±»',
  `capital` varchar(50) NOT NULL COMMENT '◊ ±æ',
  `ascendent` varchar(50) NOT NULL COMMENT '÷˜“™æ∫’˘”≈ ∆',
  `quality` varchar(50) DEFAULT NULL COMMENT '÷ ¡ø‘»Œ',
  `sales` varchar(50) NOT NULL COMMENT '»´ƒÍœ˙ €',
  `staff` varchar(50) NOT NULL COMMENT '‘±π§',
  `foundyear` varchar(50) NOT NULL COMMENT '≥…¡¢ƒÍ∑›',
  `payment` varchar(50) DEFAULT NULL COMMENT '∏∂øÓ∑Ω Ω',
  `markets_main` varchar(50) DEFAULT NULL COMMENT '÷˜“™œ˙ € –≥°',
  `markets_other` varchar(50) DEFAULT NULL COMMENT '∆‰À˚œ˙ € –≥°',
  `replace_work` varchar(50) DEFAULT NULL COMMENT '¥˙π§ –≥°',
  `rdman` varchar(50) NOT NULL COMMENT '—–∑¢»À‘±◊‹ ˝',
  `engineer` varchar(50) NOT NULL COMMENT 'π§≥Ã ¶◊‹ ˝',
  `summary` varchar(255) DEFAULT NULL COMMENT 'ºÚΩÈ',
  `content` text COMMENT 'ƒ⁄»›',
  `province` varchar(20) DEFAULT NULL COMMENT ' °∑›',
  `city` varchar(20) DEFAULT NULL COMMENT '≥« –',
  `area` varchar(20) DEFAULT NULL COMMENT '«¯',
  `address` varchar(200) DEFAULT NULL COMMENT 'µÿ÷∑',
  `postcode` varchar(100) DEFAULT NULL COMMENT '” ±‡',
  `linkman` varchar(20) DEFAULT NULL COMMENT '¡™œµ»À',
  `email` varchar(100) DEFAULT NULL COMMENT 'email',
  `tel` varchar(200) DEFAULT NULL COMMENT 'µÁª∞',
  `fax` varchar(100) DEFAULT NULL COMMENT '¥´’Ê',
  `msn` varchar(100) DEFAULT NULL COMMENT 'msn',
  `qq` varchar(100) DEFAULT NULL COMMENT 'QQ',
  `hits` int(11) DEFAULT '0' COMMENT 'µ„ª˜¥Œ ˝',
  `addtime` varchar(30) DEFAULT NULL COMMENT 'ÃÌº” ±º‰',
  `addip` varchar(30) DEFAULT NULL COMMENT 'ÃÌº”ip',
  `updatetime` varchar(30) DEFAULT NULL COMMENT '–ﬁ∏ƒ ±º‰',
  `updateip` varchar(30) DEFAULT NULL COMMENT '–ﬁ∏ƒip',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=latin1 AUTO_INCREMENT=1 ;
...
CREATE TABLE IF NOT EXISTS `zx_credit` (
  ...
  `addip` varchar(30) DEFAULT NULL COMMENT 'ÃÌº”IP',
  `updatetime` varchar(11) DEFAULT NULL COMMENT '◊Ó∫Û∏¸–¬ ±º‰',
  `updateip` varchar(30) DEFAULT NULL COMMENT '◊Ó∫Û∏¸–¬ID',
  PRIMARY KEY (`user_id`)
) ENGINE=MyISAM DEFAULT CHARSET=gbk COMMENT='ª·‘±ª˝∑÷';
...
CREATE TABLE IF NOT EXISTS `zx_credit_log` (
  ...
  `addip` varchar(30) DEFAULT NULL COMMENT 'ÃÌº”IP',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=gbk COMMENT='ª·‘±ª˝∑÷»’÷æ' AUTO_INCREMENT=362 ;
...
CREATE TABLE IF NOT EXISTS `zx_credit_rank` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(50) DEFAULT NULL COMMENT 'µ»º∂√˚≥∆',
  `rank` int(11) DEFAULT '0' COMMENT 'µ»º∂',
  `point1` int(11) DEFAULT '0' COMMENT 'ø™ º∑÷÷µ',
  `point2` int(11) DEFAULT '0' COMMENT '◊Ó∫Û∑÷÷µ',
  `pic` varchar(100) DEFAULT NULL COMMENT 'Õº∆¨',
  `remark` text COMMENT '±∏◊¢',
  `addtime` int(11) DEFAULT NULL COMMENT 'ÃÌº” ±º‰',
  `addip` varchar(30) DEFAULT NULL COMMENT 'ÃÌº”IP',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=gbk COMMENT='ª·‘±ª˝∑÷µ»º∂' AUTO_INCREMENT=27 ;
...
CREATE TABLE IF NOT EXISTS `zx_credit_type` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(50) DEFAULT NULL COMMENT 'ª˝∑÷√˚≥∆',
  `nid` varchar(50) DEFAULT NULL COMMENT 'ª˝∑÷¥˙¬Î',
  `value` int(11) DEFAULT '0' COMMENT 'ª˝∑÷ ˝÷µ',
...
) ENGINE=MyISAM  DEFAULT CHARSET=gbk COMMENT='ª˝∑÷¿‡–Õ' AUTO_INCREMENT=15 ;
...
CREATE TABLE IF NOT EXISTS `zx_discount` (
  ...
  `litpic` varchar(255) DEFAULT NULL COMMENT '…œ¥´Õº∆¨',
  `type` varchar(50) NOT NULL COMMENT '∑÷¿‡:»Á£¨–›œ–£¨√¿ ≥£¨π∫ŒÔ...',
  `business_district` varchar(30) DEFAULT NULL COMMENT '…Ã»¶',
  `company_id` int(11) DEFAULT NULL COMMENT '…Ãº“',
  `name` varchar(100) DEFAULT NULL COMMENT '±ÍÃ‚',
  ...
  `tag` varchar(100) DEFAULT NULL COMMENT '±Í«©',
  `start_date` varchar(30) DEFAULT NULL COMMENT 'ø™ º ±º‰',
  `end_date` varchar(30) DEFAULT NULL COMMENT 'Ω· ¯ ±º‰',
  `comment` text COMMENT 'ƒ⁄»›',
  `hit` int(11) DEFAULT '0' COMMENT 'µ„ª˜¥Œ ˝',
  `top` int(11) DEFAULT '0' COMMENT '∂•¥Œ ˝',
  `remark` text COMMENT '±∏◊¢',
  `post_user` varchar(50) DEFAULT NULL COMMENT '∑¢≤º’ﬂ',
  `flag` varchar(30) DEFAULT NULL COMMENT '∂®“Â Ù–‘',
  `order` varchar(10) DEFAULT NULL COMMENT '≈≈–Ú',
  `status` int(2) DEFAULT NULL COMMENT '◊¥Ã¨',
  `addtime` varchar(30) DEFAULT NULL COMMENT 'ÃÌº” ±º‰',
  `addip` varchar(30) DEFAULT NULL COMMENT 'ÃÌº”ip',
  `updatetime` varchar(30) DEFAULT NULL COMMENT '∏¸–¬ ±º‰',
...
CREATE TABLE IF NOT EXISTS `zx_discount_company` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(30) NOT NULL COMMENT '…Ãº“√˚≥∆',
  `flag` varchar(30) DEFAULT NULL COMMENT '∂®“Â Ù–‘',
  `status` int(2) DEFAULT NULL COMMENT '◊¥Ã¨',
  `order` varchar(10) DEFAULT NULL COMMENT '≈≈–Ú',
  `litpic` varchar(255) DEFAULT NULL COMMENT '…œ¥´Õº∆¨',
  `goods` varchar(255) DEFAULT NULL COMMENT 'ªÓ∂Ø≤˙∆∑',
  `type` varchar(50) DEFAULT NULL COMMENT '”≈ª›¿‡–Õ',
  `linkman` varchar(20) DEFAULT NULL COMMENT '¡™œµ»À',
  `tel` varchar(20) DEFAULT NULL COMMENT '¡™œµµÁª∞',
  `content` text NOT NULL COMMENT 'π´ÀæºÚΩÈ',
  `hits` int(11) DEFAULT '0' COMMENT 'µ„ª˜¥Œ ˝',
  `addtime` varchar(30) DEFAULT NULL COMMENT 'ÃÌº” ±º‰',
  `addip` varchar(30) DEFAULT NULL COMMENT 'ÃÌº”ip',
  PRIMARY KEY (`id`)
...
CREATE TABLE IF NOT EXISTS `zx_fee` (
  ...
  `value` varchar(30) DEFAULT NULL COMMENT '÷µ',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=gbk AUTO_INCREMENT=1 ;
...
CREATE TABLE IF NOT EXISTS `zx_friends` (
  ...
  `content` varchar(255) DEFAULT NULL COMMENT 'ƒ⁄»›',
  `addtime` varchar(50) DEFAULT NULL,
  `addip` varchar(50) DEFAULT NULL,
  PRIMARY KEY (`id`)
...
CREATE TABLE IF NOT EXISTS `zx_friends_request` (
  ...
  `addip` varchar(50) DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=gbk COMMENT='∫√”—º«¬º' AUTO_INCREMENT=1 ;
...
CREATE TABLE IF NOT EXISTS `zx_home` (
  ...
  `source` varchar(50) DEFAULT NULL COMMENT '¿¥‘¥',
  `publish` varchar(50) DEFAULT NULL COMMENT '∑¢≤º ±º‰',
  `xiaoqu` varchar(50) DEFAULT NULL COMMENT '–°«¯',
  `shi` varchar(10) DEFAULT NULL COMMENT ' “',
  `ting` varchar(10) DEFAULT NULL COMMENT 'Ã¸',
  `wei` varchar(10) DEFAULT NULL COMMENT 'Œ¿',
  `louceng` varchar(10) DEFAULT NULL COMMENT '¬•≤„',
  `zonglouceng` varchar(10) DEFAULT NULL COMMENT '◊‹¬•≤„',
  `loupan` varchar(10) DEFAULT NULL COMMENT '¬•≈Ã',
  `zhucegongsi` varchar(10) DEFAULT NULL COMMENT ' «∑Ò◊¢≤·π´Àæ',
  `mianji` varchar(10) DEFAULT NULL COMMENT '√Êª˝',
  `mianji1` varchar(10) DEFAULT NULL COMMENT '∆⁄Õ˚√Êª˝1',
  `mianji2` varchar(10) DEFAULT NULL COMMENT '∆⁄Õ˚√Êª˝2',
  `fangshi` varchar(10) DEFAULT NULL COMMENT '≥ˆ◊‚∑Ω Ω',
  `leixing` varchar(10) DEFAULT NULL COMMENT '¿‡–Õ',
  `zhuangxiu` varchar(10) DEFAULT NULL COMMENT '◊∞–ﬁ',
  `chaoxiang` varchar(10) DEFAULT NULL COMMENT '≥ØœÚ',
  `zujin` varchar(10) DEFAULT NULL COMMENT '◊‚Ω',
  `jiage` varchar(10) DEFAULT NULL COMMENT ' €º€',
  `jiage1` varchar(10) DEFAULT NULL COMMENT '∆⁄Õ˚ €º€1',
  `jiage2` varchar(10) DEFAULT NULL COMMENT '∆⁄Õ˚ €º€2',
  `jiageleixing` varchar(10) DEFAULT NULL COMMENT 'º€∏Ò¿‡–Õ',
  `lishijingying` varchar(10) DEFAULT NULL COMMENT '¿˙ ∑æ≠”™',
  `jibenqingkuang` varchar(10) DEFAULT NULL COMMENT 'ª˘±æ«Èøˆ',
  `diduan` varchar(10) DEFAULT NULL COMMENT 'µÿ∂Œ',
  `diduan1` varchar(10) DEFAULT NULL COMMENT 'µÿ∂Œ1',
  `diduan2` varchar(10) DEFAULT NULL COMMENT 'µÿ∂Œ2',
  `fukuan` varchar(10) DEFAULT NULL COMMENT '∏∂øÓ∑Ω Ω',
  `linjin` varchar(10) DEFAULT NULL COMMENT '¡ŸΩ¸',
  `peizhi` varchar(50) DEFAULT NULL COMMENT '≈‰÷√',
  `tupian` varchar(250) DEFAULT NULL COMMENT 'Õº∆¨',
  `xianxingbie` varchar(250) DEFAULT NULL COMMENT 'œﬁ÷∆–‘±',
  `chuzufangjian` varchar(250) DEFAULT NULL COMMENT '≥ˆ◊‚∑øº‰',
  `chuzuleixing` varchar(250) DEFAULT NULL COMMENT '≥ˆ◊‚¿‡–Õ',
  `content` varchar(255) DEFAULT NULL COMMENT '≤π≥‰Àµ√˜',
  `lianxiren` varchar(50) DEFAULT NULL COMMENT '¡™œµ»À',
  `dianhua` varchar(50) DEFAULT NULL COMMENT 'µÁª∞',
...
CREATE TABLE IF NOT EXISTS `zx_integral` (
  ...
  `name` varchar(100) DEFAULT NULL COMMENT 'ŒÔ∆∑√˚≥∆',
  ...
  `area` int(11) DEFAULT NULL COMMENT '«¯',
  `litpic` varchar(100) DEFAULT NULL COMMENT 'Õº∆¨',
  `content` text COMMENT 'œÍœ∏–≈œ¢',
  `hits` int(11) DEFAULT '0' COMMENT 'µ„ª˜¥Œ ˝',
  `top` int(11) DEFAULT '0' COMMENT '∂•¥Œ ˝',
  `flag` varchar(30) DEFAULT NULL COMMENT '∂®“Â Ù–‘',
  `order` varchar(10) DEFAULT NULL COMMENT '≈≈–Ú',
...
CREATE TABLE IF NOT EXISTS `zx_invest` (
  ...
  `style` varchar(50) DEFAULT NULL COMMENT 'ªπøÓ∑Ω Ω',
  `account` varchar(50) DEFAULT NULL COMMENT 'ΩË¥˚◊‹Ω∂Ó',
  `apr` varchar(50) DEFAULT NULL COMMENT 'ƒÍ¿˚¬ ',
  `lowest_account` varchar(50) DEFAULT NULL COMMENT '◊ÓµÕÕ∂±ÍΩ∂Ó',
  `most_account` varchar(50) DEFAULT NULL COMMENT '◊Ó∂‡Õ∂±Í◊‹∂Ó',
  `valid_time` varchar(50) DEFAULT NULL COMMENT '”––ß ±º‰',
  `award` varchar(50) DEFAULT NULL COMMENT 'Õ∂±ÍΩ±¿¯',
...
CREATE TABLE IF NOT EXISTS `zx_invite` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=gbk COMMENT='’–∆∏¡–±Ì' AUTO_INCREMENT=2 ;
...
CREATE TABLE IF NOT EXISTS `zx_invite_type` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=gbk COMMENT='’–∆∏¿‡–Õ' AUTO_INCREMENT=4 ;
...
CREATE TABLE IF NOT EXISTS `zx_limitapp` (
  ...
  `status` int(2) DEFAULT '0' COMMENT '◊¥Ã¨',
  `order` int(11) DEFAULT '0' COMMENT '≈≈–Ú',
  `account` varchar(255) DEFAULT NULL COMMENT '“™‘ˆº”µƒ∂Ó∂»',
  `recommend_userid` varchar(255) DEFAULT NULL COMMENT 'Õ∆ºˆ»À',
  `content` text COMMENT 'œÍœ∏Àµ√˜',
  `other_content` text COMMENT '∆‰À˚µÿ∑ΩœÍœ∏Àµ√˜',
  `verify_userid` int(11) DEFAULT NULL COMMENT '…Û∫À»À',
  `verify_time` varchar(50) DEFAULT NULL COMMENT '…Û∫À ±º‰',
  `verify_remark` varchar(50) DEFAULT NULL COMMENT '±∏◊¢',
  `addtime` varchar(50) DEFAULT NULL,
  `addip` varchar(50) DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=gbk AUTO_INCREMENT=2 ;
...
CREATE TABLE IF NOT EXISTS `zx_linkage` (
  ...
  `pid` varchar(30) DEFAULT NULL COMMENT 'À˘ Ù¡™∂Ø',
  `name` varchar(250) DEFAULT NULL COMMENT '¡™∂Ø√˚≥∆',
  `value` varchar(250) DEFAULT NULL COMMENT '¡™∂Øµƒ÷µ',
  `addtime` int(10) DEFAULT '0',
  `addip` varchar(20) DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `type_id` (`type_id`),
  KEY `type_ida` (`type_id`,`value`)
) ENGINE=MyISAM  DEFAULT CHARSET=gbk AUTO_INCREMENT=492 ;
...
CREATE TABLE IF NOT EXISTS `zx_links` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=gbk COMMENT='”—«È¡¨Ω”¡–±Ì' AUTO_INCREMENT=23 ;
...
CREATE TABLE IF NOT EXISTS `zx_links_type` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=gbk COMMENT='”—«È¡¥Ω”¿‡–Õ' AUTO_INCREMENT=3 ;
...
CREATE TABLE IF NOT EXISTS `zx_message` (
  ...
  `name` varchar(255) DEFAULT NULL COMMENT '±ÍÃ‚',
  `status` int(2) DEFAULT '0' COMMENT '◊¥Ã¨',
  `type` varchar(50) DEFAULT '0' COMMENT '¿‡–Õ',
  ...
  `addip` varchar(50) DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=gbk COMMENT='∂Ãœ˚œ¢' AUTO_INCREMENT=533 ;
...
CREATE TABLE IF NOT EXISTS `zx_site` (
  ...
  `addip` varchar(50) DEFAULT NULL,
  PRIMARY KEY (`site_id`)
) ENGINE=MyISAM  DEFAULT CHARSET=gbk AUTO_INCREMENT=63 ;
...
CREATE TABLE IF NOT EXISTS `zx_upfiles` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(30) DEFAULT NULL COMMENT '√˚≥∆',
  `code` varchar(50) DEFAULT NULL COMMENT 'ƒ£øÈ',
  `aid` varchar(50) DEFAULT NULL COMMENT 'À˘ Ùƒ£øÈid',
  `status` int(2) DEFAULT '0' COMMENT '◊¥Ã¨',
  `user_id` int(11) NOT NULL DEFAULT '0',
  `filetype` varchar(50) DEFAULT NULL COMMENT 'Œƒº˛¿‡–Õ',
  `filename` varchar(100) DEFAULT NULL COMMENT 'Œƒº˛√˚≥∆',
  `filesize` int(10) DEFAULT '0' COMMENT 'Œƒº˛¥Û–°',
  `fileurl` varchar(200) DEFAULT NULL COMMENT 'Œƒº˛µÿ÷∑',
  ...
  `updateip` varchar(30) DEFAULT NULL COMMENT '–ﬁ∏ƒip',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=gbk AUTO_INCREMENT=455 ;
...
CREATE TABLE IF NOT EXISTS `zx_user` (
  ...
  `invite_userid` varchar(11) DEFAULT NULL COMMENT '—˚«Î∫√”—',
  `invite_money` varchar(10) DEFAULT '0' COMMENT '—˚«Î◊¢≤·Ã·≥…',
  ...
  `remind` text COMMENT 'Ã·–—…Ë÷√',
  `privacy` text COMMENT '“˛ÀΩ…Ë÷√',
...
CREATE TABLE IF NOT EXISTS `zx_userinfo` (
  ...
  `source` varchar(50) DEFAULT NULL COMMENT '¿¥‘¥',
  `publish` varchar(50) DEFAULT NULL COMMENT '∑¢≤º ±º‰',
  `marry` varchar(50) DEFAULT NULL COMMENT 'ªÈ“ˆ',
  `child` varchar(10) DEFAULT NULL COMMENT '◊”≈Æ',
  `education` varchar(10) DEFAULT NULL COMMENT '—ß¿˙',
  `income` varchar(10) DEFAULT NULL COMMENT ' ’»Î',
  `shebao` varchar(10) DEFAULT NULL COMMENT '…Á±£',
  `shebaoid` varchar(50) DEFAULT NULL COMMENT '…Á±£∫≈',
  `housing` varchar(10) DEFAULT NULL COMMENT '◊°∑øÃıº˛',
  `car` varchar(10) DEFAULT NULL COMMENT '≥µ',
  `late` varchar(10) DEFAULT NULL COMMENT '”‚∆⁄',
  `house_address` varchar(10) DEFAULT NULL COMMENT '∑ø≤˙µÿ÷∑',
  `house_area` varchar(10) DEFAULT NULL COMMENT '∑ø≤˙√Êª˝',
  `house_year` varchar(10) DEFAULT NULL COMMENT 'Ω®÷˛ƒÍ∑›',
  `house_status` varchar(10) DEFAULT NULL COMMENT 'π©øÓ',
  `house_holder1` varchar(10) DEFAULT NULL COMMENT '∑ø◊”À˘”–»®1',
  `house_holder2` varchar(10) DEFAULT NULL COMMENT '∑ø◊”À˘”–»®1',
  `house_right1` varchar(10) DEFAULT NULL COMMENT '∑ø◊”∑›∂Ó1',
  `house_right2` varchar(10) DEFAULT NULL COMMENT '∑ø◊”∑›∂Ó2',
  `house_loanyear` varchar(10) DEFAULT NULL COMMENT '¥˚øÓƒÍœﬁ',
  `house_loanprice` varchar(10) DEFAULT NULL COMMENT '√ø‘¬π©øÓ',
  `house_balance` varchar(10) DEFAULT NULL COMMENT '¥˚øÓ”‡∂Ó',
  `house_bank` varchar(10) DEFAULT NULL COMMENT '“¯––',
  `company_name` varchar(10) DEFAULT NULL COMMENT 'π´Àæ√˚≥∆',
  `company_type` varchar(10) DEFAULT NULL COMMENT 'π´Àæ–‘÷ ',
  `company_industry` varchar(10) DEFAULT NULL COMMENT 'π´Àæ––“µ',
  `company_office` varchar(10) DEFAULT NULL COMMENT 'π§◊˜÷∞Œª',
  `company_jibie` varchar(10) DEFAULT NULL COMMENT 'π§◊˜º∂±',
  `company_worktime1` varchar(10) DEFAULT NULL COMMENT 'π§◊˜ ±º‰1',
  `company_worktime2` varchar(10) DEFAULT NULL COMMENT 'π§◊˜ ±º‰2',
  `company_workyear` varchar(10) DEFAULT NULL COMMENT 'π§◊˜ƒÍœﬁ',
  `company_tel` varchar(50) DEFAULT NULL COMMENT 'π´ÀæµÁª∞',
  `company_address` varchar(100) DEFAULT NULL COMMENT 'π´Àæµÿ÷∑',
  `company_weburl` varchar(100) DEFAULT NULL COMMENT 'π´ÀæÕ¯’æ',
  `company_reamrk` varchar(250) DEFAULT NULL COMMENT 'π´Àæ±∏◊¢',
  `private_type` varchar(10) DEFAULT NULL COMMENT '¿‡±',
  `private_date` varchar(10) DEFAULT NULL COMMENT '»’∆⁄',
  `private_place` varchar(10) DEFAULT NULL COMMENT '≥°À˘',
  `private_rent` varchar(10) DEFAULT NULL COMMENT '◊‚Ω',
  `private_term` varchar(10) DEFAULT NULL COMMENT '◊‚∆⁄',
  `private_taxid` varchar(30) DEFAULT NULL COMMENT 'π§…ÃÀ∞ŒÒ',
  `private_commerceid` varchar(50) DEFAULT NULL COMMENT 'π§…Ãµ«º«∫≈',
  `private_income` varchar(100) DEFAULT NULL COMMENT ' ’»Î',
  `private_employee` varchar(100) DEFAULT NULL COMMENT 'πÕ‘±',
  `finance_repayment` varchar(100) DEFAULT NULL COMMENT '√ø‘¬Œﬁµ÷—∫¥˚øÓªπøÓ∂Ó',
  `finance_property` varchar(100) DEFAULT NULL COMMENT '◊‘”–∑ø≤˙',
  `finance_amount` varchar(100) DEFAULT NULL COMMENT '√ø‘¬∑øŒ›∞¥Ω“Ω∂Ó',
  `finance_car` varchar(10) DEFAULT NULL COMMENT '◊‘”–∆˚≥µ',
  `finance_caramount` varchar(100) DEFAULT NULL COMMENT '√ø‘¬∆˚≥µ∞¥Ω“Ω∂Ó',
  `finance_creditcard` varchar(100) DEFAULT NULL COMMENT '–≈”√ø®Ω∂Ó',
  `mate_name` varchar(100) DEFAULT NULL COMMENT '≈‰≈º√˚◊÷',
  `mate_salary` varchar(10) DEFAULT NULL COMMENT '–Ω◊ ',
  `mate_phone` varchar(100) DEFAULT NULL COMMENT ' ÷ª˙',
  `mate_tel` varchar(100) DEFAULT NULL COMMENT 'µÁª∞',
  `mate_type` varchar(10) DEFAULT NULL COMMENT 'π§◊˜¿‡–Õ',
  `mate_office` varchar(10) DEFAULT NULL COMMENT 'π§◊˜÷∞Œª',
  `mate_address` varchar(250) DEFAULT NULL COMMENT 'µÿ÷∑',
  `mate_income` varchar(100) DEFAULT NULL COMMENT ' ’»Î',
  `education_record` varchar(100) DEFAULT NULL COMMENT '—ß¿˙',
  `education_school` varchar(200) DEFAULT NULL COMMENT '—ß–£',
  `education_study` varchar(200) DEFAULT NULL COMMENT '◊®“µ',
  `education_time1` varchar(20) DEFAULT NULL COMMENT ' ±º‰1',
  `education_time2` varchar(20) DEFAULT NULL COMMENT ' ±º‰2',
  `tel` varchar(50) DEFAULT NULL COMMENT 'µÁª∞',
  `phone` varchar(50) DEFAULT NULL COMMENT ' ÷ª˙',
  `post` varchar(50) DEFAULT NULL COMMENT '” ±‡',
  `address` varchar(50) DEFAULT NULL COMMENT '” ±‡',
  `province` varchar(20) DEFAULT NULL COMMENT ' °∑›',
  `city` varchar(20) DEFAULT NULL COMMENT '≥« –',
  `area` varchar(20) DEFAULT NULL COMMENT '«¯',
  `linkman1` varchar(50) DEFAULT NULL COMMENT '¡™œµ»À1',
  `relation1` varchar(50) DEFAULT NULL COMMENT 'πÿœµ1',
  `tel1` varchar(50) DEFAULT NULL COMMENT 'µÁª∞1',
  `phone1` varchar(50) DEFAULT NULL COMMENT ' ÷ª˙1',
  `linkman2` varchar(50) DEFAULT NULL COMMENT '¡™œµ»À2',
  `relation2` varchar(50) DEFAULT NULL COMMENT 'πÿœµ2',
  `tel2` varchar(50) DEFAULT NULL COMMENT 'µÁª∞2',
  `phone2` varchar(50) DEFAULT NULL COMMENT ' ÷ª˙2',
  `linkman3` varchar(50) DEFAULT NULL COMMENT '¡™œµ»À3',
  `relation3` varchar(50) DEFAULT NULL COMMENT 'πÿœµ3',
  `tel3` varchar(50) DEFAULT NULL COMMENT 'µÁª∞3',
  `phone3` varchar(50) DEFAULT NULL COMMENT ' ÷ª˙3',
  `msn` varchar(50) DEFAULT NULL COMMENT 'MSN',
  `qq` varchar(50) DEFAULT NULL COMMENT 'QQ',
  `wangwang` varchar(50) DEFAULT NULL COMMENT 'WANGWANG',
  `ability` varchar(250) DEFAULT NULL COMMENT '∏ˆ»Àƒ‹¡¶',
  `interest` varchar(250) DEFAULT NULL COMMENT '∏ˆ»À∞Æ∫√',
  `others` varchar(250) DEFAULT NULL COMMENT '∆‰À˚Àµ√˜',
  `experience` text COMMENT 'π§◊˜æ≠¿˙',
  `addtime` varchar(50) DEFAULT NULL,
  `addip` varchar(50) DEFAULT NULL,
  `updatetime` varchar(50) DEFAULT NULL,
  `updateip` varchar(50) DEFAULT NULL,
...
) ENGINE=MyISAM  DEFAULT CHARSET=gbk AUTO_INCREMENT=340 ;
...
CREATE TABLE IF NOT EXISTS `zx_user_log` (
  ...
  `addip` varchar(50) DEFAULT NULL,
  PRIMARY KEY (`log_id`)
) ENGINE=MyISAM  DEFAULT CHARSET=gbk AUTO_INCREMENT=495 ;
...
CREATE TABLE IF NOT EXISTS `zx_user_trend` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=gbk COMMENT='”√ªß≤Ÿ◊˜º«¬º' AUTO_INCREMENT=19 ;
...
CREATE TABLE IF NOT EXISTS `zx_vip_card` (
  ...
  `serial_number` varchar(15) NOT NULL COMMENT 'VIPø®∫≈',
  ...
  `vct_name` varchar(40) DEFAULT NULL COMMENT '≥‰÷µø®¿‡–Õ',
  ...
  `create_user` varchar(20) NOT NULL COMMENT '…˙≥…’ﬂ',
  `remark` text COMMENT '±∏◊¢',
...
) ENGINE=MyISAM DEFAULT CHARSET=latin1 COMMENT='VIPø®' AUTO_INCREMENT=1 ;
...
CREATE TABLE IF NOT EXISTS `zx_vip_card_type` (
  ...
  `name` varchar(40) DEFAULT NULL COMMENT '¿‡–Õ√˚≥∆',
...
CREATE TABLE IF NOT EXISTS `zx_vip_user` (
  ...
  `card_number` varchar(15) NOT NULL COMMENT 'VIPø®∫≈',
  `flag` varchar(30) DEFAULT NULL COMMENT '∂®“Â Ù–‘',
  `order` varchar(10) DEFAULT NULL COMMENT '≈≈–Ú',
  `hits` int(11) DEFAULT NULL COMMENT 'µ„ª˜¥Œ ˝',
  `addtime` varchar(30) DEFAULT NULL COMMENT 'ÃÌº” ±º‰',
...
) ENGINE=MyISAM DEFAULT CHARSET=latin1 COMMENT='VIPø®”√ªß' AUTO_INCREMENT=1 ;
...
CREATE TABLE IF NOT EXISTS `zx_yginfo` (
  ...
  `user_id` int(11) DEFAULT '0' COMMENT '”√ªßID',
  `status` int(2) DEFAULT '0' COMMENT '◊¥Ã¨',
  `height` varchar(255) DEFAULT NULL COMMENT '…Ì∏ﬂ',
  `minzu` varchar(255) DEFAULT NULL COMMENT '√Ò◊Â',
  `jiguan` varchar(255) DEFAULT NULL COMMENT 'ºÆπ·',
  `zhengzhi` varchar(255) DEFAULT NULL COMMENT '’˛÷Œ√Ê√≤',
  `techang` varchar(255) DEFAULT NULL COMMENT 'Ãÿ≥§',
  `marray` varchar(255) DEFAULT NULL COMMENT 'ªÈ∑Ò',
  `zhuanye` varchar(255) DEFAULT NULL COMMENT '◊®“µ',
  `xueli` varchar(255) DEFAULT NULL COMMENT '—ß¿˙',
  `idcard` varchar(255) DEFAULT NULL COMMENT '…Ì∑›÷§∫≈¬Î',
  `zhiye` varchar(255) DEFAULT NULL COMMENT '÷∞“µ',
  `school` varchar(255) DEFAULT NULL COMMENT '—ß–£',
  `danwei` varchar(255) DEFAULT NULL COMMENT 'µ•Œª',
  `dizhi` varchar(255) DEFAULT NULL COMMENT 'µÿ÷∑',
  `linkman` varchar(255) DEFAULT NULL COMMENT '¡™œµ»À',
  `linktel` varchar(255) DEFAULT NULL COMMENT '¡™œµµÁª∞',
  `fuwu` text,
  `jianli` text,
  `liyou` varchar(255) DEFAULT NULL COMMENT '…Í«Î¿Ì”…',
  `verify_userid` int(11) DEFAULT NULL COMMENT '…Û∫À»À',
  `verify_time` varchar(50) DEFAULT NULL COMMENT '…Û∫À ±º‰',
  `verify_remark` varchar(250) DEFAULT NULL COMMENT '…Û∫À±∏◊¢',
  `addtime` varchar(50) DEFAULT NULL,
  `addip` varchar(50) DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=gbk COMMENT='“Âπ§–≈œ¢' AUTO_INCREMENT=1 ;
