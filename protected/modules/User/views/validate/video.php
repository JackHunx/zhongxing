...
<?php }elseif($info['video_status']==1){?>
		...
		您的视频认证已经提交，客服人员会及时的跟你联系。</font>。
        <?}else{?>
        欢迎进行视频认证。<div class="user_right_border">
			<div class="c">
				<form action="" method="post">
				<input type="hidden" name="video" value="2" />
				如果你需要视频认证，请点按钮提交。<input type="submit" value="提交申请" name="submit" />
