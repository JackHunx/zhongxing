<div class="wrap950 list_1">
	...
	<div class="content">
			...
			<ul class="ul_li_1">
				...
				<li>验证码：<input name="Vip[verifyCode]" type="text" size="11" maxlength=""  tabindex="3"/>&nbsp;	<?php $this->widget('CCaptcha',array('showRefreshButton'=>false,'clickableImage'=>true,'imageOptions'=>array('alt'=>'点击换图','title'=>'点击换图','style'=>'cursor:pointer'))); ?></li>
