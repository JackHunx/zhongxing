<div class="user_action_main topborder">
	...
	<div class="user_action_reg_left">
		...
		<div class="user_action_reg_submit">
			...
			<strong><?php //echo $email?></strong> 将收到一封认证邮件，请查收。
成功认证后，你就可以畅快使用站内所有功能。<br><br>

<a href="http://mail.163.com" target="_blank"><img src="<?php echo Yii::app()->baseUrl?>/images/renzheng.png" align="absmiddle"></a><br><br>
