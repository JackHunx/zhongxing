...
<div class="view">
	...
	<?php /*
	<b><?php echo CHtml::encode($data->getAttributeLabel('award_fund')); ?>:</b>
	<?php echo CHtml::encode($data->award_fund); ?>
	<br />

	<b><?php echo CHtml::encode($data->getAttributeLabel('award_account')); ?>:</b>
	<?php echo CHtml::encode($data->award_account); ?>
	<br />
