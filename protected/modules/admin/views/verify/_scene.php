					...
					<div class="tab-content default-tab" id="tab1">
						...
						<form action="<?php echo Yii::app()->baseUrl; ?>/index.php?r=admin/verify" method="post">
							...
							<fieldset> <!-- Set class to "column-left" or "column-right" on fieldsets to divide the form into columns -->
								...
								<p>
									<label>审核备注</label>
									<textarea class="textarea" name="validate[remark]" cols="40" rows="5">现场认证</textarea>
								</p>
								
								<p>
                                    <input type="hidden" name="validate[type_id]" value="5" />
                                    <input type="hidden" name="validate[id]" value="<?php echo
$_GET['id']; ?>" />
                                    <input type="hidden" name="cate" value="scene_status" />
