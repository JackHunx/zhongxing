...
/**
 * This is the model class for table "zx_user_sendemail_log".
 *
 * The followings are the available columns in table 'zx_user_sendemail_log':
 * @property string $id
 ...
 */
class UserSendemailLog extends CActiveRecord
{
	/**
