...
/**
 * This is the model class for table "zx_user_amount".
 *
 * The followings are the available columns in table 'zx_user_amount':
 * @property string $id
 ...
 */
class UserAmount extends CActiveRecord
{
    public $username;
    /**
    ...
    public function rules()
    {
        ...
        return array(
            array(
                ...
                'integerOnly' => true),
            array(
                'credit, credit_use, credit_nouse, borrow_vouch, borrow_vouch_use, borrow_vouch_nouse, tender_vouch, tender_vouch_use, tender_vouch_nouse',
                'length',
                'max' => 11),
            // The following rule is used by search().
            // Please remove those attributes that should not be searched.
            array(
                'id, user_id, credit, credit_use, credit_nouse, borrow_vouch, borrow_vouch_use, borrow_vouch_nouse, tender_vouch, tender_vouch_use, tender_vouch_nouse,username',
                'safe',
                'on' => 'search'),
            );
    }
    ...
    public function search()
    {
        ...
        return new CActiveDataProvider($this, array(
            ...
            'sort' => array(
                'defaultOrder' => 'id ASC',
                'attributes' => array('username' => array(
                        'asc' => 'user.username',
