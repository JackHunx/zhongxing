...
/**
 * This is the model class for table "zx_bbs_settings".
 *
 * The followings are the available columns in table 'zx_bbs_settings':
 * @property string $id
 ...
 */
class BbsSettings extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @param string $className active record class name.
	 * @return BbsSettings the static model class
	 */
