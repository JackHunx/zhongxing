...
/**
 * This is the model class for table "zx_borrow_vouch_collection".
 *
 * The followings are the available columns in table 'zx_borrow_vouch_collection':
 * @property string $id
 ...
 */
class BorrowVouchCollection extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @param string $className active record class name.
	 * @return BorrowVouchCollection the static model class
	 */
	...
	{
		return 'zx_borrow_vouch_collection';
	}
	...
	public function rules()
	{
		...
		return array(
			array('status, user_id, borrow_id, order, vouch_id', 'numerical', 'integerOnly'=>true),
			array('repay_time, repay_yestime, repay_account, repay_yesaccount, addtime, addip', 'length', 'max'=>50),
			// The following rule is used by search().
			// Please remove those attributes that should not be searched.
			array('id, status, user_id, borrow_id, order, vouch_id, repay_time, repay_yestime, repay_account, repay_yesaccount, addtime, addip', 'safe', 'on'=>'search'),
		);
	}
	...
	public function search()
	{
		...
		$criteria->compare('vouch_id',$this->vouch_id);
