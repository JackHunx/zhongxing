...
class UserAmountapply extends CActiveRecord
{
    ...
    public function rules()
    {
        ...
        return array(
            ...
            array(
                'id, user_id, type, account, account_new, account_old, status, addtime, content, remark, verify_remark, verify_time, verify_user, addip,username',
                'safe',
                'on' => 'search'),
            );
    }
