...
/**
 * This is the model class for table "zx_site".
 *
 * The followings are the available columns in table 'zx_site':
	...
	public function rules()
	{
		...
		return array(
           // array('verifyCode','captcha'),
			...
			array('site_id, code, name, nid, pid, rank, url, aurl, isurl, order, status, style, litpic, content, list_name, content_name, sitedir, visit_type, index_tpl, list_tpl, content_tpl, title, keywords, description, user_id, addtime, addip', 'safe', 'on'=>'search'),
		);
	}
