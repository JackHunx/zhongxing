...
/**
 * This is the model class for table "zx_user_backup".
 *
 * The followings are the available columns in table 'zx_user_backup':
 * @property string $id
 ...
 */
class UserBackup extends CActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			...
			array('user_tel, user_email, user_phone, user_qq, user_address, user_nation, user_realname, source, publish, marry, shebaoid, company_tel, private_commerceid, tel, phone, post, address, linkman1, relation1, tel1, phone1, linkman2, relation2, tel2, phone2, linkman3, relation3, tel3, phone3, msn, qq, wangwang, addtime, addip, updatetime, updateip', 'length', 'max'=>50),
