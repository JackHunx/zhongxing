...
class Attestation extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('user_id, type_id, status, jifen, verify_user', 'numerical', 'integerOnly'=>true),
			...
			array('id, user_id, type_id, name, status, litpic, content, jifen, pic, pic2, pic3, verify_time, verify_user, verify_remark, addtime, addip', 'safe', 'on'=>'search'),
		);
	}
